package com.hit.searchbarapplication.adapter;
...
import com.hit.searchbarapplication.ItemAnimation;
import com.hit.searchbarapplication.R;
import com.hit.searchbarapplication.UserDetails;
...
public class RecyclerviewAdapter extends RecyclerView.Adapter<RecyclerviewAdapter.RecyclerviewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerviewHolder holder, int position) {
        ...
        holder.userImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(context, "User Image Clicked ", Toast.LENGTH_SHORT).show();
            }
        });
